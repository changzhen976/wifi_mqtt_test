...
//-------------------WIFI-CFG----------------------------------------//
#define CONFIG_ESP_WIFI_SSID "home_iot"
#define CONFIG_ESP_WIFI_PASSWORD "iothomemqtt"
...
#define CONFIG_BROKER_URL "mqtt://192.168.2.217:1883"
#define CONFIG_BROKER_USERNAME "homeassistant"
#define CONFIG_BROKER_PASSWORD "yeihoo8aquoh8ong1Ior0Peg6ah5lah8fohtaibee5Wooloh7ahloo0ich7pe8oh"
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_subscribe(client, "/home/test/value_1", 1);
        ESP_LOGI(MQTTTAG, "sent subscribe successful, msg_id=%d", msg_id);
        vTaskDelay(pdMS_TO_TICKS(200));
        msg_id = esp_mqtt_client_publish(client, "/home/test/value_1", "data_3", 0, 1, 0);
    ...
    case MQTT_EVENT_SUBSCRIBED:
        ...
        msg_id = esp_mqtt_client_publish(client, "/home/test/value_1", "data", 0, 0, 0);
        ESP_LOGI(MQTTTAG, "sent publish successful, msg_id=%d", msg_id);
        break;
